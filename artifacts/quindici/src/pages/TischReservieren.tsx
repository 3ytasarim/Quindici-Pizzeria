            ...
            {!submitted ? (
                  ...
                  <div className="p-8 md:p-10">
                    ...
                    <div className="space-y-5">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-stone-400 mt-2">Für mehr als 10 Personen rufen Sie uns bitte an.</p>
                      </div>
                    </div>
              ...
              >
                ...
                >
                  ...
                  <strong>{formatDate(f1.date)}</strong> um <strong>{f1.time} Uhr</strong> ({f1.guests} {f1.guests === "1" ? "Person" : "Personen"}) erhalten.
                </motion.p>
                <motion.p
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  Wir melden uns in Kürze unter <span className="text-stone-600">{f2.email}</span> oder <span className="text-stone-600">{f2.phone}</span> zur Bestätigung.
                </motion.p>
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
